...
String i18n_securityAlert(bool isBN) => isBN ? 'জরুরী এলার্ট' : 'Emergency Alert';
...
String i18n_utilityContacts(bool isBN) => isBN ? 'জরুরী সেবা' : 'Home Service';
...
String i18n_systemSettings(bool isBN) => isBN ? 'ডিভাইস সেটিংস' : 'System Settings';
...
String i18n_weFound(bool isBN) => isBN ? 'আমরা আপনার পার্সেলটি পেয়েছি / পার্সেলটি পাওয়া গেছে' : 'We’ve found your PARCEL';
String i18n_weNoFound(bool isBN) => isBN ? 'দুঃখিত! আপনার পার্সেলটি পাওয়া যাচ্ছে না!!' : 'Sorry!! We did not find your PARCEL';
...
String i18n_deliveryNote(bool isBN) => isBN ? 'ডেলিভারী নোট' : 'Delivery Note';
...
String i18n_tapToAssign(bool isBN) => isBN ? 'বসবাসকার নির্ধারণ করতে ট্যাপ করুন' : 'Tap to assign resident(s)';
