...
Container parkStatusGridTile({required BuildContext context, String guestName = "N/A", bool isFree = true, required int index, String? guestOf}) {
  return Container(
      alignment: Alignment.center,
      padding: primaryPadding,
      decoration: BoxDecoration(color: trueWhite, borderRadius: primaryBorderRadius),
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        flatAvatar(context: context, label: index.toString()),
