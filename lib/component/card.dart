...
Container basic2LineInfoCard({required String key, required String value, required BuildContext context}) {
  return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(value, textScaleFactor: .8, style: Theme.of(context).textTheme.displayMedium?.copyWith(color: trueWhite, fontWeight: FontWeight.w600))
      ]));
}
